...
TEST_GROUND_TRUTH_JSON_PATH = './test_suite/data/m1.json' # change this to the test ground truth
VIDEO_PATH = './test_suite/data/m1.mp4' # change this to the test video
TEST_IMG_PATH = './test/tstIMG/'
DRIVE_TEST_CSV_PATH = './test/m1.csv'

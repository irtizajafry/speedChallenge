...
for idx in tqdm(range(1, len(data) - 1)):
    ...
    x2_copy = cv2.resize(x2_copy, (1088, 1920), interpolation = cv2.INTER_AREA)
...
clip.write_videofile("movie-vTest2.mp4", fps = 30)
